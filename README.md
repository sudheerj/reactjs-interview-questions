...
|3| [What are the \<Router> components of React Router v4](#what-are-the-router-components-of-react-router-v4) |
|4| [What is the purpose of push and replace methods of history](#what-is-the-purpose-of-push-and-replace-methods-of-history) |
|5| [How do you programmatically navigate using React router v4](#how-do-you-programmatically-navigate-using-react-router-v4) |
|6| [How to get query parameters in React Router v4](#how-to-get-query-parameters-in-react-router-v4) |
|7| [Why you get "Router may have only one child element" warning](#why-you-get-router-may-have-only-one-child-element-warning) |
|8| [How to pass params to history.push method in React Router v4](#how-to-pass-params-to-historypush-method-in-react-router-v4) |
|9| [How to implement default or NotFound page](#how-to-implement-default-or-notfound-page) |
|10| [How to get history on React Router v4](#how-to-get-history-on-react-router-v4) |
|11| [How to perform automatic redirect after login](#how-to-perform-automatic-redirect-after-login) |
|   | **React Internationalization** |
|1| [What is React-Intl](#what-is-react-intl) |
|2| [What are the main features of React Intl](#what-are-the-main-features-of-react-intl) |
|3| [What are the two ways of formatting in React Intl](#what-are-the-two-ways-of-formatting-in-react-intl) |
|4| [How to use FormattedMessage as placeholder using React Intl](#how-to-use-formattedmessage-as-placeholder-using-react-intl) |
|5| [How to access current locale with React Intl](#how-to-access-current-locale-with-react-intl) |
|6| [How to format date using React Intl](#how-to-format-date-using-react-intl) |
|   | **React Testing** |
|1| [What is Shallow Renderer in React testing](#what-is-shallow-renderer-in-react-testing) |
|2| [What is TestRenderer package in React](#what-is-testrenderer-package-in-react) |
|3| [What is the purpose of ReactTestUtils package](#what-is-the-purpose-of-reacttestutils-package) |
|4| [What is Jest](#what-is-jest) |
|5| [What are the advantages of Jest over Jasmine](#what-are-the-advantages-of-jest-over-jasmine) |
|6| [Give a simple example of Jest test case](#give-a-simple-example-of-jest-test-case) |
|   | **React Redux** |
|1| [What is Flux](#what-is-flux) |
|2| [What is Redux](#what-is-redux) |
|3| [What are the core principles of Redux](#what-are-the-core-principles-of-redux) |
|4| [What are the downsides of Redux compared to Flux](#what-are-the-downsides-of-redux-compared-to-flux) |
|5| [What is the difference between mapStateToProps() and mapDispatchToProps()](#what-is-the-difference-between-mapstatetoprops-and-mapdispatchtoprops) |
|6| [Can I dispatch an action in reducer](#can-i-dispatch-an-action-in-reducer) |
|7| [How to access Redux store outside a component](#how-to-access-redux-store-outside-a-component) |
|8| [What are the drawbacks of MVW pattern](#what-are-the-drawbacks-of-mvw-pattern) |
|9| [Are there any similarities between Redux and RxJS](#are-there-any-similarities-between-redux-and-rxjs) |
|10| [How to dispatch an action on load](#how-to-dispatch-an-action-on-load) |
|11| [How to use connect from React Redux](#how-to-use-connect-from-react-redux) |
|12| [How to reset state in Redux](#how-to-reset-state-in-redux) |
|13| [Whats the purpose of at symbol in the redux connect decorator](#whats-the-purpose-of-at-symbol-in-the-redux-connect-decorator) |
|14| [What is the difference between React context and React Redux](#what-is-the-difference-between-react-context-and-react-redux) |
|15| [Why are Redux state functions called reducers](#why-are-redux-state-functions-called-reducers) |
|16| [How to make AJAX request in Redux](#how-to-make-ajax-request-in-redux) |
|17| [Should I keep all component's state in Redux store](#should-i-keep-all-components-state-in-redux-store) |
|18| [What is the proper way to access Redux store](#what-is-the-proper-way-to-access-redux-store) |
...
|20| [What is the purpose of the constants in Redux](#what-is-the-purpose-of-the-constants-in-redux) |
|21| [What are the different ways to write mapDispatchToProps()](#what-are-the-different-ways-to-write-mapdispatchtoprops) |
|22| [What is the use of the ownProps parameter in mapStateToProps() and mapDispatchToProps()](#what-is-the-use-of-the-ownprops-parameter-in-mapstatetoprops-and-mapdispatchtoprops) |
|23| [How to structure Redux top level directories](#how-to-structure-redux-top-level-directories) |
|24| [What is redux-saga](#what-is-redux-saga) |
|25| [What is the mental model of redux-saga](#what-is-the-mental-model-of-redux-saga) |
|26| [What are the differences between call and put in redux-saga](#what-are-the-differences-between-call-and-put-in-redux-saga) |
|27| [What is Redux Thunk](#what-is-redux-thunk) |
|28| [What are the differences between redux-saga and redux-thunk](#what-are-the-differences-between-redux-saga-and-redux-thunk) |
|29| [What is Redux DevTools](#what-is-redux-devtools) |
|30| [What are the features of Redux DevTools](#what-are-the-features-of-redux-devtools) |
|31| [What are Redux selectors and Why to use them](#what-are-redux-selectors-and-why-to-use-them) |
|32| [What is Redux Form](#what-is-redux-form) |
|33| [What are the main features of Redux Form](#what-are-the-main-features-of-redux-form) |
|34| [How to add multiple middlewares to Redux](#how-to-add-multiple-middlewares-to-redux) |
|35| [How to set initial state in Redux](#how-to-set-initial-state-in-redux) |
|36| [How Relay is different from Redux](#how-relay-is-different-from-redux) |
|37| [What is an action in Redux](#what-is-an-action-in-redux) |
|   | **React Native** |
...
|7| [How to use Polymer in React](#how-to-use-polymer-in-react) |
|8| [What are the advantages of React over Vue.js](#what-are-the-advantages-of-react-over-vuejs) |
|9| [What is the difference between React and Angular](#what-is-the-difference-between-react-and-angular) |
|10| [Why React tab is not showing up in DevTools](#why-react-tab-is-not-showing-up-in-devtools) |
|11| [What are styled components](#what-are-styled-components) |
|12| [Give an example of Styled Components](#give-an-example-of-styled-components) |
|13| [What is Relay](#what-is-relay) |
|14| [How to use TypeScript in create-react-app application](#how-to-use-typescript-in-create-react-app-application) |
|   | **Miscellaneous** |
|1| [What are the main features of reselect library](#what-are-the-main-features-of-reselect-library) |
|2| [Give an example of reselect usage](#give-an-example-of-reselect-usage) |
|3| [Does the statics object work with ES6 classes in React](#does-the-statics-object-work-with-es6-classes-in-react) |
|4| [Can Redux only be used with React](#can-redux-only-be-used-with-react) |
|5| [Do you need to have a particular build tool to use Redux](#do-you-need-to-have-a-particular-build-tool-to-use-redux) |
|6| [How Redux Form initialValues get updated from state](#how-redux-form-initialvalues-get-updated-from-state) |
|7| [How React PropTypes allow different type for one prop](#how-react-proptypes-allow-different-types-for-one-prop) |
|8| [Can I import an SVG file as react component](#can-i-import-an-svg-file-as-react-component) |
|9| [Why are inline ref callbacks or functions not recommended](#why-are-inline-ref-callbacks-or-functions-not-recommended)|
|10| [What is render hijacking in React](#what-is-render-hijacking-in-react)|
|11| [What are HOC factory implementations](#what-are-hoc-factory-implementations)|
|12| [How to pass numbers to React component](#how-to-pass-numbers-to-react-component)|
|13| [Do I need to keep all my state into Redux? Should I ever use react internal state](#do-i-need-to-keep-all-my-state-into-redux-should-i-ever-use-react-internal-state)|
|14| [What is the purpose of registerServiceWorker in React](#what-is-the-purpose-of-registerserviceworker-in-react)|
|15| [What is React memo function](#what-is-react-memo-function)|
|16| [What is React lazy function](#what-is-react-lazy-function)|
|17| [How to prevent unnecessary updates using setState](#how-to-prevent-unnecessary-updates-using-setstate)|
|18| [How do you render Array, Strings and Numbers in React 16 Version](#how-do-you-render-array-strings-and-numbers-in-react-16-version)|
|19| [How to use class field declarations syntax in React classes](#how-to-use-class-field-declarations-syntax-in-react-classes)|
|20| [What are hooks](#what-are-hooks)|
|21| [What are the rules needs to follow for hooks](#what-are-the-rules-needs-to-follow-for-hooks)|
|22| [How to ensure hooks followed the rules in your project](#how-to-ensure-hooks-followed-the-rules-in-your-project)|
|23| [What are the differences between Flux and Redux](#what-are-the-differences-between-flux-and-redux)|
|24| [What are the benefits of React Router V4](#what-are-the-benefits-of-react-router-v4)|
|25| [Can you describe about componentDidCatch lifecycle method signature](#can-you-describe-about-componentdidcatch-lifecycle-method-signature)|
|26| [In which scenarios error boundaries do not catch errors](#in-which-scenarios-error-boundaries-do-not-catch-errors)|
|27| [Why do not you need error boundaries for event handlers](#why-do-not-you-need-error-boundaries-for-event-handlers)|
|28| [What is the difference between try catch block and error boundaries](#what-is-the-difference-between-try-catch-block-and-error-boundaries)|
|29| [What is the behavior of uncaught errors in react 16](#what-is-the-behavior-of-uncaught-errors-in-react-16)|
|30| [What is the proper placement for error boundaries](#what-is-the-proper-placement-for-error-boundaries)|
|31| [What is the benefit of component stack trace from error boundary](#what-is-the-benefit-of-component-stack-trace-from-error-boundary)|
|32| [What is the required method to be defined for a class component](#what-is-the-required-method-to-be-defined-for-a-class-component)|
|33| [What are the possible return types of render method](#what-are-the-possible-return-types-of-render-method)|
|34| [What is the main purpose of constructor](#what-is-the-main-purpose-of-constructor)|
|35| [Is it mandatory to define constructor for React component](#is-it-mandatory-to-define-constructor-for-react-component)|
|36| [What are default props](#what-are-default-props)|
|37| [Why should not call setState in componentWillUnmount](#why-should-not-call-setstate-in-componentwillunmount)|
|38| [What is the purpose of getDerivedStateFromError](#what-is-the-purpose-of-getderivedstatefromerror)|
|39| [What is the methods order when component re-rendered](#what-is-the-methods-order-when-component-re-rendered)|
|40| [What are the methods invoked during error handling](#what-are-the-methods-invoked-during-error-handling)|
|41| [What is the purpose of displayName class property](#what-is-the-purpose-of-displayname-class-property)|
|42| [What is the browser support for react applications](#what-is-the-browser-support-for-react-applications)|
|43| [What is the purpose of unmountComponentAtNode method](#what-is-the-purpose-of-unmountcomponentatnode-method)|
|44| [What is code-splitting](#what-is-code-splitting)|
|45| [What is the benefit of strict mode](#what-is-the-benefit-of-strict-mode)|
|46| [What are Keyed Fragments](#what-are-keyed-fragments)|
|47| [Does React support all HTML attributes](#does-react-support-all-html-attributes)|
|48| [What are the limitations with HOCs](#what-are-the-limitations-with-hocs)|
|49| [How to debug forwardRefs in DevTools](#how-to-debug-forwardrefs-in-devtools)|
|50| [When component props defaults to true](#when-component-props-defaults-to-true)|
|51| [What is NextJS and major features of it](#what-is-nextjs-and-major-features-of-it)|
|52| [How do you pass an event handler to a component](#how-do-you-pass-an-event-handler-to-a-component)|
|53| [Is it good to use arrow functions in render methods](#is-it-good-to-use-arrow-functions-in-render-methods)|
|54| [How to prevent a function from being called multiple times](#how-to-prevent-a-function-from-being-called-multiple-times)|
|55| [How JSX prevents Injection Attacks](#how-jsx-prevents-injection-attacks)|
|56| [How do you update rendered elements](#how-do-you-update-rendered-elements)|
|57| [How do you say that props are read only](#how-do-you-say-that-props-are-read-only)|
|58| [How do you say that state updates are merged](#how-do-you-say-that-state-updates-are-merged)|
|59| [How do you pass arguments to an event handler](#how-do-you-pass-arguments-to-an-event-handler)|
|60| [How to prevent component from rendering](#how-to-prevent-component-from-rendering)|
|61| [What are the conditions to safely use the index as a key](#what-are-the-conditions-to-safely-use-the-index-as-a-key)|
|62| [Is it keys should be globally unique](#is-it-keys-should-be-globally-unique)|
|63| [What is the popular choice for form handling](#what-is-the-popular-choice-for-form-handling)|
|64| [What are the advantages of formik over redux form library](#what-are-the-advantages-of-formik-over-redux-form-library)|
|65| [Why do you not required to use inheritance](#why-do-you-not-required-to-use-inheritance)|
|66| [Can I use web components in react application](#can-i-use-web-components-in-react-application)|
|67| [What is dynamic import](#what-is-dynamic-import)|
|68| [What are loadable components](#what-are-loadable-components)|
|69| [What is suspense component](#what-is-suspense-component)|
|70| [What is route based code splitting](#what-is-route-based-code-splitting)|
|71| [Give an example on How to use context](#give-an-example-on-how-to-use-context)|
|72| [What is the purpose of default value in context](#what-is-the-purpose-of-default-value-in-context)|
|73| [How do you use contextType](#how-do-you-use-contexttype)|
|74| [What is a consumer](#what-is-a-consumer)|
|75| [How do you solve performance corner cases while using context](#how-do-you-solve-performance-corner-cases-while-using-context)|
|76| [What is the purpose of forward ref in HOCs](#what-is-the-purpose-of-forward-ref-in-hocs)|
|77| [Is it ref argument available for all functions or class components](#is-it-ref-argument-available-for-all-functions-or-class-components)|
|78| [Why do you need additional care for component libraries while using forward refs](#why-do-you-need-additional-care-for-component-libraries-while-using-forward-refs)|
|79| [How to create react class components without ES6](#how-to-create-react-class-components-without-es6)|
|80| [Is it possible to use react without JSX](#is-it-possible-to-use-react-without-jsx)|
|81| [What is diffing algorithm](#what-is-diffing-algorithm)|
|82| [What are the rules covered by diffing algorithm](#what-are-the-rules-covered-by-diffing-algorithm)|
|83| [When do you need to use refs](#when-do-you-need-to-use-refs)|
|84| [Is it prop must be named as render for render props](#is-it-prop-must-be-named-as-render-for-render-props)|
|85| [What are the problems of using render props with pure components](#what-are-the-problems-of-using-render-props-with-pure-components)|
|85| [How do you create HOC using render props](#how-do-you-create-hoc-using-render-props)|
|87| [What is windowing technique](#what-is-windowing-technique)|
|88| [How do you print falsy values in JSX](#how-do-you-print-falsy-values-in-jsx)|
|89| [What is the typical use case of portals](#what-is-the-typical-use-case-of-portals?)|
|90| [How do you set default value for uncontrolled component](#how-do-you-set-default-value-for-uncontrolled-component)|
|91| [What is your favorite React stack](#what-is-your-favorite-react-stack)|
|92| [What is the difference between Real DOM and Virtual DOM](#what-is-the-difference-between-real-dom-and-virtual-dom)|
|93| [How to add Bootstrap to a react application](#how-to-add-bootstrap-to-a-react-application)|
|94| [Can you list down top websites or applications using react as front end framework](#can-you-list-down-top-websites-or-applications-using-react-as-front-end-framework)|
|95| [Is it recommended to use CSS In JS technique in React](#is-it-recommended-to-use-css-in-js-technique-in-react)|
|96| [Do I need to rewrite all my class components with hooks](#do-i-need-to-rewrite-all-my-class-components-with-hooks)|
|97| [How to fetch data with React Hooks](#how-to-fetch-data-with-react-hooks)|
|98| [Is Hooks cover all use cases for classes](#is-hooks-cover-all-use-cases-for-classes)|
|99| [What is the stable release for hooks support](#what-is-the-stable-release-for-hooks-support)|
...
83. ### Why function is preferred over object for `setState()`
...
89. ### What are the exceptions on React component naming
...
97. ### How to conditionally apply class attributes
...
111. ### How can we find the version of React at runtime in the browser
...
112. ### What are the approaches to include polyfills in your `create-react-app`
...
113. ### How to use https instead of http in create-react-app
...
114. ### How to avoid using relative path imports in create-react-app
...
115. ### How to add Google Analytics for React Router
...
116. ### How to update a component every second
...
117. ### How do you apply vendor prefixes to inline styles in React
...
118. ### How to import and export components using React and ES6
...
9. ### Why are inline ref callbacks or functions not recommended
...
11. ### What are HOC factory implementations
    ...
    **Props Proxy.** In this approach, the render method of the HOC returns a React Element of the type of the WrappedComponent. We also pass through the props that the HOC receives, hence the name **Props Proxy**.
...
12. ### How to pass numbers to React component
...
13. ### Do I need to keep all my state into Redux? Should I ever use react internal state
...
14. ### What is the purpose of registerServiceWorker in React
...
16. ### What is React lazy function
...
17. ### How to prevent unnecessary updates using setState
...
18. ### How do you render Array, Strings and Numbers in React 16 Version
...
19. ### How to use class field declarations syntax in React classes
...
21. ### What are the rules needs to follow for hooks
...
22. ### How to ensure hooks followed the rules in your project
...
23. ### What are the differences between Flux and Redux
...
24. ### What are the benefits of React Router V4
...
25. ### Can you describe about componentDidCatch lifecycle method signature
...
26. ### In which scenarios error boundaries do not catch errors
...
27. ### Why do not you need error boundaries for event handlers
...
28. ### What is the difference between try catch block and error boundaries
...
29. ### What is the behavior of uncaught errors in react 16

    In React 16, errors that were not caught by any error oundary will result in unmounting of the whole React component tree. The reason behind this decision is that it is worse to leave corrupted UI in place than to completely remove it. For example, it is worse for a payments app to display a wrong amount than to render nothing.

    **[⬆ Back to Top](#table-of-contents)**

30. ### What is the proper placement for error boundaries
...
31. ### What is the benefit of component stack trace from error boundary
...
32. ### What is the required method to be defined for a class component

    The `render()` method is the only required method in a class component. i.e, All methods other than render method are optional for a class component.

    **[⬆ Back to Top](#table-of-contents)**

33. ### What are the possible return types of render method
...
34. ### What is the main purpose of constructor
...
35. ### Is it mandatory to define constructor for React component
...
37. ### Why should not call setState in componentWillUnmount

    You should not call `setState()` in `componentWillUnmount()` because once a component instance is unmounted, it will never be mounted again.

    **[⬆ Back to Top](#table-of-contents)**

38. ### What is the purpose of getDerivedStateFromError
...
39. ### What is the methods order when component re-rendered
...
40. ### What are the methods invoked during error handling
...
41. ### What is the purpose of displayName class property
...
42. ### What is the browser support for react applications

    React supports all popular browsers, including Internet Explorer 9 and above, although some polyfills are required for older browsers such as IE 9 and IE 10. If you use  **es5-shim and es5-sham** polyfill then it even support old browsers that doesn't support ES5 methods.

    **[⬆ Back to Top](#table-of-contents)**

43. ### What is the purpose of unmountComponentAtNode method
...
45. ### What is the benefit of strict mode
...
47. ### Does React support all HTML attributes
...
48. ### What are the limitations with HOCs
...
49. ### How to debug forwardRefs in DevTools
...
50. ### When component props defaults to true
...
51. ### What is NextJS and major features of it
...
52. ### How do you pass an event handler to a component
...
53. ### Is it good to use arrow functions in render methods
...
54. ### How to prevent a function from being called multiple times
...
55. ### How JSX prevents Injection Attacks
...
56. ### How do you update rendered elements
...
57. ### How do you say that props are read only
...
58. ### How do you say that state updates are merged
...
59. ### How do you pass arguments to an event handler
...
60. ### How to prevent component from rendering
...
61. ### What are the conditions to safely use the index as a key
...
62. ### Is it keys should be globally unique
...
63. ### What is the popular choice for form handling
...
64. ### What are the advantages of formik over redux form library
...
65. ### Why do you not required to use inheritance
...
66. ### Can I use web components in react application
...
68. ### What are loadable components
...
70. ### What is route based code splitting
...
71. ### Give an example on How to use context
...
72. ### What is the purpose of default value in context
...
75. ### How do you solve performance corner cases while using context
...
76. ### What is the purpose of forward ref in HOCs
...
77. ### Is it ref argument available for all functions or class components

    Regular function or class components don’t receive the ref argument, and ref is not available in props either. The second ref argument only exists when you define a component with React.forwardRef call.

    **[⬆ Back to Top](#table-of-contents)**

78. ### Why do you need additional care for component libraries while using forward refs

    When you start using forwardRef in a component library, you should treat it as a breaking change and release a new major version of your library. This is because your library likely has a different behavior such as what refs get assigned to, and what types are exported. These changes can break apps and other libraries that depend on the old behavior.

    **[⬆ Back to Top](#table-of-contents)**

79. ### How to create react class components without ES6
...
80. ### Is it possible to use react without JSX
...
82. ### What are the rules covered by diffing algorithm
...
83. ### When do you need to use refs
...
84. ### Is it prop must be named as render for render props
...
85. ### What are the problems of using render props with pure components

    If you create a function inside a render method, it negates the purpose of pure component. Because the shallow prop comparison will always return false for new props, and each render in this case will generate a new value for the render prop. You can solve this issue by defining the render function as instance method.

    **[⬆ Back to Top](#table-of-contents)**

86. ### How do you create HOC using render props
...
89. ### What is the typical use case of portals
...
90. ### How do you set default value for uncontrolled component
...
91. ### What is your favorite React stack
    ...
    You can clone the project [https://github.com/react-boilerplate/react-boilerplate](https://github.com/react-boilerplate/react-boilerplate) and start working on any new react project.

    **[⬆ Back to Top](#table-of-contents)**

92. ### What is the difference between Real DOM and Virtual DOM
...
93. ### How to add Bootstrap to a react application
...
94. ### Can you list down top websites or applications using react as front end framework
...
95. ### Is it recommended to use CSS In JS technique in React

    React does not have any opinion about how styles are defined but if you are a beginner then good starting point is to define your styles in a separate *.css file as usual and refer to them using className. This functionality is not part of React but came from third-party libraries. But If you want to try a different approach(CSS-In-JS) then styled-components library is a good option.

    **[⬆ Back to Top](#table-of-contents)**

96. ### Do I need to rewrite all my class components with hooks

    No. But you can try Hooks in a few components(or new components) without rewriting any existing code. Because there are no plans to remove classes in ReactJS.

    **[⬆ Back to Top](#table-of-contents)**

97. ### How to fetch data with React Hooks
...
98. ### Is Hooks cover all use cases for classes

    Hooks doesn't cover all use cases of classes but there is a plan to add them soon. Currently there are no Hook equivalents to the uncommon **getSnapshotBeforeUpdate** and **componentDidCatch** lifecycles yet.

    **[⬆ Back to Top](#table-of-contents)**

99. ### What is the stable release for hooks support
