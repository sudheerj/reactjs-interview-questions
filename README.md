...
|55 | [چطوری از error boundaryها توی نسخه ۱۵ ریکت مدیریت شدن؟](#error-boundaryها-توی-ریاکت-نسخه-16-چیکار-میکنن) |
|56 | [روش‌های پیشنهادی برای type checking چیه؟](#چطوری-از-error-boundaryها-توی-نسخه-۱۵-ریکت-مدیریت-شدن) |
|57 | [کاربرد پکیج react-dom چیه؟](#روشهای-پیشنهادی-برای-type-checking-چیه) |
|58 | [کاربرد متد render از پکیج react-dom چیه؟](#کاربرد-پکیج-react-dom-چیه) |
|59 | [ReactDOMServer چیه؟](#کاربرد-متد-render-از-پکیج-react-dom-چیه) |
|60 | [چطوری از InnerHtml توی ری‌اکت استفاده کنیم؟](#ReactDOMServer-چیه) |
|61 | [چطوری توی ری‌اکت استایل‌دهی می‌کنیم؟](#چطوری-از-InnerHtml-توی-ریاکت-استفاده-کنیم) |
|62 | [تفاوت eventهای ری‌اکت چیه؟](#چطوری-توی-ریاکت-استایلدهی-میکنیم) |
|63 | [اگه توی constructor بیاییم و setState کنیم چی میشه؟](#تفاوت-eventهای-ریاکت-چیه) |
|64 | [تاثیر استفاده از اینرکس به عنوان key چیه؟](#اگه-توی-constructor-بیاییم-و-setState-کنیم-چی-میشه) |
|65 | [نظرت راجع به استفاده از setState توی متد componentWillMount چیه؟](#تاثیر-استفاده-از-اینرکس-به-عنوان-key-چیه) |
|66 | [اگه از prop توی مقداردهی اولیه state استفاده کنیم چی میشه؟](#نظرت-راجع-به-استفاده-از-setState-توی-متد-componentWillMount-چیه) |
|67 | [چطوری کامپوننت رو با بررسی یه شریط رندر می‌کنیم؟](#اگه-از-prop-توی-مقداردهی-اولیه-state-استفاده-کنیم-چی-میشه)
|68 | [چرا وقتی propها رو روی یه DOM Elemnt می‌آییم spread می‌کنیم باید مراقب باشیم؟](#چطوری-کامپوننت-رو-با-بررسی-یه-شریط-رندر-میکنیم) |
|69 | [چطوری از decoratorها توی ری‌اکت استفاده کنیم؟](#چرا-وقتی-propها-رو-روی-یه-DOM-Elemnt-میآییم-spread-میکنیم-باید-مراقب-باشیم) |
|70 | [چطوری یه کامپوننت رو memoize می‌کنیم؟](#چطوری-از-decoratorها-توی-ریاکت-استفاده-کنیم) |
|71 | [چطوری باید Server-Side Rendering یا SSR رو توی ری‌اکت پیاده کنیم؟](#چطوری-یه-کامپوننت-رو-memoize-میکنیم) |
|72 | [چطوری حالت production رو برای ری‌اکت فعال کنیم؟](#چطوری-باید-Server-Side-Rendering-یا-SSR-رو-توی-ریاکت-پیاده-کنیم) |
|73 | [CRA چیه و چه مزایایی داره؟](#چطوری-حالت-production-رو-برای-ریاکت-فعال-کنیم) |
|74 | [ترتیب اجرا شدن متد‌های life cycle چطوریه؟](#CRA-چیه-و-چه-مزایایی-داره) |
|75 | [کدوم متد‌های life cycle توی نسخه 16 ری‌اکت منسوخ شدن؟](#ترتیب-اجرا-شدن-متدهای-life-cycle-چطوریه) |
|76 | [کاربرد متد getDerivedStateFromProps چیه؟](#کدوم-متدهای-life-cycle-توی-نسخه-16-ریاکت-منسوخ-شدن) |
|77 | [کاربرد متد getSnapshotBeforeUpdate چیه؟](#کاربرد-متد-getDerivedStateFromProps-چیه) |
|78 | [آیا هوک‌ها جای render props و HOC رو می‌گیرن؟](#کاربرد-متد-getSnapshotBeforeUpdate-چیه) |
|79 | [روش توضیه شده برای نام‌گذاری کامپوننت‌ها چیه؟](#آیا-هوکها-جای-render-props-و-HOC-رو-میگیرن) |
|80 | [روش توصیه شده برای ترتیب متدها در کلاس کامپوننت‌ها چیه؟](#روش-توضیه-شده-برای-نامگذاری-کامپوننتها-چیه) |
|81 | [کامپوننت تعویض کننده یا switching چیه؟](#روش-توصیه-شده-برای-ترتیب-متدها-در-کلاس-کامپوننتها-چیه) |
|82 | [چرت نیاز میشه به تایع setState یه فانکشن callback پاس بدیم؟](#کامپوننت-تعویض-کننده-یا-switching-چیه) |
|83 | [حالت strict توی ری‌اکت چیکار می‌کنه؟](#چرت-نیاز-میشه-به-تایع-setState-یه-فانکشن-callback-پاس-بدیم) |
|84 | [Mixin‌های ری‌اکت چی هستن؟](#حالت-strict-توی-ریاکت-چیکار-میکنه) |
|85 | [چرا isMounted آنتی پترن هست و روش بهتر انجامش چیه؟](#Mixinهای-ریاکت-چی-هستن) |
|86 | [پشتیبانی ری‌اکت از pointer eventها چطوریه؟](#چرا-isMounted-آنتی-پترن-هست-و-روش-بهتر-انجامش-چیه) |
|87 | [چرا باید اسم کامپوننت با حرف بزرگ شروع بشه؟](#پشتیبانی-ریاکت-از-pointer-eventها-چطوریه) |
|88 | [آیا propهای custom توی ری‌اکت پشتیبانی میشن؟](#چرا-باید-اسم-کامپوننت-با-حرف-بزرگ-شروع-بشه) |
|89 | [تفاوت‌های  constructor و getInitialState چیه؟](#آیا-propهای-custom-توی-ریاکت-پشتیبانی-میشن) |
|90 | [می‌تونیم یه کامپوننت رو بدون setState ری‌رندر کنیم؟](#تفاوتهای-constructor-و-getInitialState-چیه) |
|91 | [تفاوت‌های فراخوانی super(#تفاوتهای-فراخوانی-super-و-superprops-توی-کلاس-کامپوننتهای-ریاکت-چیه) و super(props) توی کلاس کامپوننت‌های ری‌اکت چیه؟](#میتونیم-یه-کامپوننت-رو-بدون-setState-ریرندر-کنیم) |
...
|103| [روش تووصیه شده برای حذف یک عنصر از آرایه توی state چیه؟](#روش-تووصیه-شده-برای-حذف-یک-عنصر-از-آرایه-توی-state-چیه) |
...
|144| [چطوری میشه localeفعلی رو توی React Intl بدست آورد؟](#چطوری-میشه-localeفعلی-رو-توی-React-Intl-بدست-آورد) |
...
|207| [یه مثال از کارکرد کتابخونهreselect بزن؟](#یه-مثال-از-کارکرد-کتابخونهreselect-بزن) |
...
|269| [گزینه‌های محبوب برای مدیریت فرم‌ا توی ری‌اکت چیا هستن؟](#گزینههای-محبوب-برای-مدیریت-فرما-توی-ریاکت-چیا-هستن)|
...
|284| [چرا در هنگام استفاده از ForwardRefها نیاز به احتیاط بیشتری در استفاده از کتابخانه های جانبی دارید؟](#چرا-در-هنگام-استفاده-از-ForwardRefها-نیاز-به-احتیاط-بیشتری-در-استفاده-از-کتابخانه-های-جانبی-دارید)|
